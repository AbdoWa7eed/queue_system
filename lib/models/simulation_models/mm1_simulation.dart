...
class MM1Simulation extends QueueSimulation {
  MM1Simulation(
      {required super.lambda, required super.mu, required super.numSimulation});
  @override
  void runSimulation() {
    ...
    for (int i = 1; i <= numSimulation; i++) {
      ...
      if (nextArrival[0] <= nextDeparture[0]) {
        ...
        points.add(Point(x: clock, y: numInSystem.toDouble()));
        print(
            "$i , $clock , Depture , $numArrival , $numDeparture , $numInSystem , $waitInSystem");
      }
    }
  }
